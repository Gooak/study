...
fun main(){
    ...
    resultList = resultList.sortedBy { abs(it- 100) }.toMutableList()
    if(abs(resultList[0] - 100) == abs(resultList[1] - 100)){
...
//각 숫자를 더한 값을 리스트에 담고 그 리스트를 절대값 - 100을 하여 정렬을 합니다.
//절대 값이 같을 경우 숫자가 더 큰 쪽으로 출력하게 만들었다.
