...
fun main(){
    ...
    var nameMap = mutableMapOf<Char, Int>()
    ...
    if(result == "") println("PREDAJA") else println(result)
}
// Map에 getOrDefault라는걸 활용하여 값이 없으면 default로 0을 들고 시작하는걸 활용하였다.
// 그런다음 정렬을 해주고 사전순으로 result를 추가하였다.
